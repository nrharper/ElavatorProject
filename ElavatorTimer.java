...
/**
 * Simple elavator timer program that calculates the time taken to travel between floors. Assumes floors are traveled in the order they are entered.
 */
public class ElavatorTimer {
    ...
    /**
     * Main method to run the elavator timer program.
     * @param args unused
     */
